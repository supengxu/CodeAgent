...
public class BashToolTests
{
    ...
    [InlineData("grep pattern file.txt", false)]
    [InlineData("head -10 file.txt", false)]
    [InlineData("tail -20 file.txt", false)]
    [InlineData("sort file.txt", false)]
    [InlineData("uniq file.txt", false)]
    [InlineData("wc -l file.txt", false)]
    [InlineData("file file.txt", false)]
    ...
    [InlineData("rm -rf *", true)]
    [InlineData("rm file.txt", true)]
    [InlineData("mkdir newdir", true)]
    [InlineData("touch newfile", true)]
    ...
    [InlineData("yarn install", true)]
    [InlineData("pip install package", true)]
